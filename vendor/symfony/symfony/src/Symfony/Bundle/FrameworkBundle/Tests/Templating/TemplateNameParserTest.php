...
class TemplateNameParserTest extends TestCase
{
    ...
    public function parseProvider()
    {
        return array(
            ...
            array('FooBundle:Post:pharmacies.html.twig', 'FooBundle:Post:pharmacies.html.twig', '@FooBundle/Resources/views/Post/pharmacies.html.twig', new TemplateReference('FooBundle', 'Post', 'index', 'html', 'twig')),
